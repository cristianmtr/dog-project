...
Employed transfer learning from existing top-performing models.

Used `keras` to specify new network tailored to this case.
...
```	
git clone https://github.com/cristianmtr/dog-project.git
cd dog-project
```
